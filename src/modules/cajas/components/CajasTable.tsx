...
export default function CajasTable({ cajas, loading, onEdit, onDelete }: Props) {
            ...
            {loading ? (
              ...
              <TableRow>
                <TableCell colSpan={5} align="center" sx={{ py: 4 }}>
                  <Typography color="text.secondary" variant="body2">
                    {search ? 'No se encontraron resultados' : 'No hay cajas registradas'}
                  </Typography>
                </TableCell>
              </TableRow>
            ) : (
              paginated.map(c => (
                <TableRow key={c.id} hover>
                  ...
                  <TableCell>
                    <Typography variant="body2" color={c.descripcion ? 'text.primary' : 'text.secondary'}>
                      {c.descripcion ?? '—'}
                    </Typography>
                  </TableCell>
