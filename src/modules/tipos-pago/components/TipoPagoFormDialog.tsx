...
type Props = {
  ...
  initialData?: TipoPago | null;
  loading?: boolean;
};

export default function TipoPagoFormDialog({ open, onClose, onSubmit, initialData, loading }: Props) {
  ...
  return (
    <Dialog open={open} onClose={onClose} fullWidth maxWidth="xs">
      <DialogTitle>
        {initialData ? 'Editar Tipo de Pago' : 'Nuevo Tipo de Pago'}
      </DialogTitle>
